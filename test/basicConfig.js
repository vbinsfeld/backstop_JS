const baseUrl = "http://google.com"; // Replace the value "http://example.com" by the base URL of the website you want to test.
...
const relativeUrls = ["/", "/imghp?hl=en", "/videohp?hl=en"];
